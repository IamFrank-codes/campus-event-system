...
Working directory: `C:\SchoolAppDev\Python\campus-event-system\user-service`

**Command:**

```text
C:\SchoolAppDev\Python\campus-event-system\user-service\venv\Scripts\python.exe -m pytest -v
```

```text
============================= test session starts =============================
platform win32 -- Python 3.13.15, pytest-9.1.1, pluggy-1.6.0 -- C:\SchoolAppDev\Python\campus-event-system\user-service\venv\Scripts\python.exe
cachedir: .pytest_cache
rootdir: C:\SchoolAppDev\Python\campus-event-system\user-service
...
Working directory: `C:\SchoolAppDev\Python\campus-event-system\event-service`

**Command:**

```text
C:\SchoolAppDev\Python\campus-event-system\event-service\venv\Scripts\python.exe -m pytest -v
```

```text
============================= test session starts =============================
platform win32 -- Python 3.13.15, pytest-9.1.1, pluggy-1.6.0 -- C:\SchoolAppDev\Python\campus-event-system\event-service\venv\Scripts\python.exe
cachedir: .pytest_cache
rootdir: C:\SchoolAppDev\Python\campus-event-system\event-service
plugins: anyio-4.14.2
collecting ... collected 9 items
...
Working directory: `C:\SchoolAppDev\Python\campus-event-system\booking-service`

**Command:**

```text
C:\SchoolAppDev\Python\campus-event-system\booking-service\venv\Scripts\python.exe -m pytest -v
```

```text
============================= test session starts =============================
platform win32 -- Python 3.13.15, pytest-9.1.1, pluggy-1.6.0 -- C:\SchoolAppDev\Python\campus-event-system\booking-service\venv\Scripts\python.exe
cachedir: .pytest_cache
rootdir: C:\SchoolAppDev\Python\campus-event-system\booking-service
plugins: anyio-4.14.2
...
Working directory: `C:\SchoolAppDev\Python\campus-event-system\notification-service`

**Command:**

```text
C:\SchoolAppDev\Python\campus-event-system\notification-service\venv\Scripts\python.exe -m pytest -v
```

```text
============================= test session starts =============================
platform win32 -- Python 3.13.15, pytest-9.1.1, pluggy-1.6.0 -- C:\SchoolAppDev\Python\campus-event-system\notification-service\venv\Scripts\python.exe
cachedir: .pytest_cache
rootdir: C:\SchoolAppDev\Python\campus-event-system\notification-service
plugins: anyio-4.14.2
...
Working directory: `C:\SchoolAppDev\Python\campus-event-system\review-services`

**Command:**

```text
C:\SchoolAppDev\Python\campus-event-system\review-services\venv\Scripts\python.exe -m pytest -v
```

```text
============================= test session starts =============================
platform win32 -- Python 3.13.15, pytest-9.1.1, pluggy-1.6.0 -- C:\SchoolAppDev\Python\campus-event-system\review-services\venv\Scripts\python.exe
cachedir: .pytest_cache
rootdir: C:\SchoolAppDev\Python\campus-event-system\review-services
plugins: anyio-4.14.2
collecting ... collected 10 items
